    ...
    api
      ...
      .catch((err) => {
        ...
        if (code === 'SESSION_EXISTS') {
          // Keep map UX consistent: only "request -> accept" creates/recovers the session in active list.
          // If backend says a session already exists, it is either still active, or backend does not allow re-request.
